    ...
    <div class='pad1'>
        ...
        <div class='clearfix'>
            ...
            <div class='fl pad1y space-right2'>
                ...
                <span class='fraction'>204/242</span>
            </div>
            ...
            <div class='fl pad1y space-right2'>
                ...
                <span class='fraction'>92/128</span>
            </div>
            ...
            <div class='fl pad1y space-right2'>
                ...
                <span class='fraction'>195/225</span>
            </div>
...
&nbsp;
    ...
    .then((res) =&gt; {
      const { request, ...authResponse } = res.json ? res : <span class="branch-1 cbranch-no" title="branch not covered" >null;</span>
...
&nbsp;
    ...
    .then((res) =&gt; {
      const { request, ...authResponse } = res.json ? <span class="branch-0 cbranch-no" title="branch not covered" >res </span>: null;
<span class="cstat-no" title="statement not covered" >      this.token.clearToken();</span>
<span class="cstat-no" title="statement not covered" >      this.log('info', 'Revoke Token () response is : ', JSON.stringify(authResponse.json, null, 2));</span>
<span class="cstat-no" title="statement not covered" >      return authResponse;</span>
    })
    .catch((e) =&gt; {
...
OAuthClient.prototype.getKeyFromJWKsURI = function getKeyFromJWKsURI(id_token, kid, request) {
  return new Promise((resolve) =&gt; {
    ...
    .then((response) =&gt; {
      ...
      const key = <span class="cstat-no" title="statement not covered" >responseBody.keys.find(<span class="fstat-no" title="function not covered" >(e</span>l) =&gt; <span class="cstat-no" title="statement not covered" >el.kid === kid)</span>;</span>
